...
describe('learningPointGenerationBatchSize', () => {
  it('keeps small queues conservative and scales large queues to reduce sequential worker jobs', () => {
    ...
    expect(learningPointGenerationBatchSize(13)).toBe(24)
    expect(learningPointGenerationBatchSize(48)).toBe(24)
    expect(learningPointGenerationBatchSize(49)).toBe(36)
    expect(learningPointGenerationBatchSize(120)).toBe(36)
    expect(learningPointGenerationBatchSize(121)).toBe(48)
    expect(learningPointGenerationBatchSize(314)).toBe(48)
  })
})
