...
P0 前置：当前 immersive_v11 family 生成 template schema V14，但 release verifier 的 V1 + startswith 宽前缀会同时接受 V14 和 V199，版本边界 fail-open。在改为精确 family/schema/Note Model/compatibility contract 校验并加入正负合同测试前，本工具不能标记为 production ready。
