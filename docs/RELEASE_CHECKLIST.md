...
当前发布目标：`v0.9.4-beta`（package version `0.9.4`）。

## 版本与仓库边界

- [ ] `package.json`、`package-lock.json`、`src-tauri/tauri.conf.json`、`src-tauri/Cargo.toml` 版本一致。
- [ ] `README.md`、`PRIVACY.md`、`SECURITY.md`、`docs/BETA_LIMITATIONS.md` 都写明 `v0.9.4-beta`。
...
- [ ] GitHub Release body 使用 `docs/RELEASE_NOTES_v0.9.4-beta.md`。
...
- [ ] PR CI 通过后合并。
- [ ] 在 `main` 合并 commit 上创建 tag `v0.9.4-beta`。
